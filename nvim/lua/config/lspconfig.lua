...
-- vim.diagnostic.config({ virtual_text = true,virtual_lines=false, signs = false })
-- enable thihs for only signs at the end
-- vim.diagnostic.config({ virtual_text = { format = function(d) return "" end }, virtual_lines = false, signs = false })
